...
void setup() {
    ...
    if (!BMI270_BMM150.begin()) {
        Serial.println("BMI270_BMM150 initialization failed!");
        while (1);
    }
}
...
void loop() {
    ...
    if (BMI270_BMM150.accelerationAvailable()) {
        BMI270_BMM150.readAcceleration(accelerationX, accelerationY, accelerationZ);
    ...
    if (BMI270_BMM150.gyroscopeAvailable()) {
        BMI270_BMM150.readGyroscope(gyroscopeX, gyroscopeY, gyroscopeZ);
    ...
    if (BMI270_BMM150.magneticFieldAvailable()) {
        BMI270_BMM150.readMagneticField(magneticFieldX, magneticFieldY, magneticFieldZ);
        Serial.print("Magnetic Field (uT): ");
        Serial.print(magneticFieldX);
        Serial.print(", ");
        Serial.print(magneticFieldY);
        Serial.print(", ");
        Serial.println(magneticFieldZ);
    }
...
float readTemperature() {
    return BMI270_BMM150.readTemperature();
}
